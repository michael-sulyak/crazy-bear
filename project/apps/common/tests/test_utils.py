...
class UtilsTestCase(unittest.TestCase):
    def test_is_sleep_hours(self):
        ...
        with utils.mock_var(utils.config, 'SLEEPING_TIME', (datetime.time(hour=0), datetime.time(hour=6),)):
        ...
        with utils.mock_var(utils.config, 'SLEEPING_TIME', (datetime.time(hour=20), datetime.time(hour=3),)):
